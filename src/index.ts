...
export {
  default as IAbstractRegistrableComponent,
} from './lib/interface/IAbstractRegistrableComponent';
export {
  default as IAbstractTransitionComponent,
} from './lib/interface/IAbstractTransitionComponent';
export {
  default as IAbstractPageTransitionComponent,
} from './lib/interface/IAbstractPageTransitionComponent';
export { COMPONENT_ID } from './lib/enum/Functions';
